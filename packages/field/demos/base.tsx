    ...
    <>
      ...
      <Descriptions column={2}>
        ...
        <Descriptions.Item label="日期时间">
          <Field text={moment('2019-11-16 12:50:26').valueOf()} valueType="dateTime" mode={state} plain={plain} />
        </Descriptions.Item>
        <Descriptions.Item label="日期">
          <Field text={moment('2019-11-16 12:50:26').valueOf()} valueType="date" mode={state} plain={plain} />
        </Descriptions.Item>
        <Descriptions.Item label="日期区间">
          <Field
            text={[moment('2019-11-16 12:50:26').add(-1, 'd').valueOf(), moment('2019-11-16 12:50:26').valueOf()]}
            plain={plain}
            valueType="dateRange"
            mode={state}
          />
        ...
        <Descriptions.Item label="时间">
          <Field text={moment('2019-11-16 12:50:26').valueOf()} plain={plain} valueType="time" mode={state} />
        </Descriptions.Item>
