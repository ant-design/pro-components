...
| minLength | The minimum number of Item. When initialValue is not passed in, the initialValue of the array with the length of minLength will be generated by default | `number` | - |
| maxLength | Maximum number of items | `number` | - |
