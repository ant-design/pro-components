...
const StatisticCard: React.FC<StatisticCardProps> & {
  ...
  const footerDom = footer && <div className={`${prefixCls}-footer ${hashId}`.trim()}>{footer}</div>;
...
const Group: React.FC<StatisticCardProps> = (props) => <StatisticCard bodyStyle={{ padding: 0 }} {...props} />;
