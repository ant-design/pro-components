...
/** `MenuDataItem` → `NavMenuNode[]` 的构建上下文（原 `MenuUtil` 类，已改为纯函数） */
type MenuNavBuildContext = BaseMenuProps &
...
function conversionMenuPath(path: string) {
...
function getIntlMenuName(ctx: MenuNavBuildContext, item: MenuDataItem) {
