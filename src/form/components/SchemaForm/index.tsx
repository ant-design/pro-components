...
import type { FormSchema, ItemType, ProFormColumnsType, ProFormRenderValueTypeHelpers } from './typing';
...
function BetaSchemaForm<T, ValueType = 'text'>(props: FormSchema<T, ValueType>) {
  ...
  const FormRenderComponents = (FormLayoutType[layoutType as 'Form'] || ProForm) as React.FC<ProFormProps<T>>;
