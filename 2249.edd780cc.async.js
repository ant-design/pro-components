"use strict";(self.webpackChunkpro_components=self.webpackChunkpro_components||[]).push([[2249],{90661:function(e,n){n.Z=`import {
  ProCard,
  ProDescriptions,
  ProForm,
  ProFormDependency,
...
`},70128:function(e,n){n.Z=`/* eslint-disable no-param-reassign */
import {
  CopyOutlined,
  DeleteOutlined,
  HeartOutlined,
...
export default Demo;
`},64412:function(e,n){n.Z=`import { LikeOutlined, UserOutlined } from '@ant-design/icons';
...
`},83490:function(e,n){n.Z=`import { PlusOutlined } from '@ant-design/icons';
import type {
  ProColumns,
...
`},63218:function(e,n){n.Z=`import { DownOutlined } from '@ant-design/icons';
import type {
  ProColumnType,
  ProFormInstance,
} from '@ant-design/pro-components';
