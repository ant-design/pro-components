...
const columns = [
  {
    title: (
      <FormattedMessage
        id="dashboardanalysistwo.table.rank"
        defaultMessage="Rank"
      />
    ),
    dataIndex: 'index',
  ...
  },
  {
    title: (
      <FormattedMessage
        id="dashboardanalysistwo.table.search-keyword"
  ...
  },
  {
    title: (
      <FormattedMessage
        id="dashboardanalysistwo.table.users"
  ...
  },
  {
    title: (
      <FormattedMessage
        id="dashboardanalysistwo.table.weekly-range"
