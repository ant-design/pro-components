...
| ignoreRules                            | Ignore rules, LightForm should not support rules, the default is false.                                                                                                                                                                    | `boolean`                                                                                             | false         |
...
| filter       | The filter area, usually used with `LightForm`         | `ReactNode`                  | -       |
