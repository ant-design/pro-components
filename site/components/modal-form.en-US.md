...
| modalProps    | Modal's props, used in the same way as [antd](https://ant.design/components/modal#api). Note: `open` is not supported, please use the top-level `open` | `Omit<ModalProps, 'open'>`                                  | -       |
