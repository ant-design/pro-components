...
| secondary  | Whether secondary control, only valid for LightForm                                                                                        | `boolean`                                           | `false`       |
| allowClear | Support for clearing, valid for LightForm, will also be passed to `fieldProps` if actively set.                                            | `boolean`                                           | `true`        |
